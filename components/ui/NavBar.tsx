...
function NavBar() { 
  return (
    <div className="w-full px-20 py-8  justify-between items-center flex text-white fixed z-30">
      <Link href="./">
        <motion.svg whileHover={{ scale: 1.5 }}
          width="72"
          height="30"
          viewBox="0 0 72 30"
          fill="none"
      ...
      <div className="links flex gap-10">
        {["Services", "Our work", "About us", "Insights", "Contact us"].map(
          (items, index) => (
            ...
            >
            <motion.p whileHover={{ scale: 1.5 }} >{items}</motion.p >
            </Link>
          )
        )}
      </div>
