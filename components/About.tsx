    ...
    <div  className="bg-[#004D43] ">
      <div className="bg-[#CDEA68]  py-28  w-full  rounded-t-[1rem]">
        <h2 className="text-6xl  px-20 leading-[4vw] font-extralight">
          ...
          <span className="underline"> sell prod­ucts</span>,<br />
          <span className="underline"> ex­plain complex ideas­</span>, and{" "}
        ...
        <div className="w-full border-t-[1px]  border-zinc-500 h-[60vh]  pt-5 px-20 text-lg">
          <div className="flex ">
            <div className="left w-1/2 ">
              ...
              <br />
              <motion.button whileHover={{ scale: 1.2 ,rotate:15}} className="bg-black rounded-full px-6 text-white flex gap-12 items-center  py-6">
                READ MORE{" "}
                <motion.div whileHover={{ scale: 4 }} className="cricle h-3 w-3 rounded-full bg-white"></motion.div>
              </motion.button>
            </div> 
